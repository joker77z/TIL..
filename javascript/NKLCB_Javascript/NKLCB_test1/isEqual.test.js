...
test('isEqual test', () => {
  ...
  expect(isEqual({ a: 1, b: { c: 2, d: { e: 3 } } }, { b: { d: { e: 3 }, c: 2 }, a: 1 })).toBe(
    true
  );
  ...
  expect(
    isEqual({ a: 1, b: { c: 2, d: { e: 3 } } }, { b: { d: { e: 3, f: 4 }, c: 2 }, a: 1 })
  ).toBe(false);
  ...
  expect(isEqual([1, { a: 2, c: { d: 3 } }], [1, { a: 2, c: { d: 3 } }])).toBe(true);
  expect(isEqual([1, 2], [1])).toBe(false);
  expect(isEqual([1, { a: 2, c: { d: 3 } }], [1, { a: 2, c: { d: 3, e: 4 } }])).toBe(false);
  ...
  expect(isEqual(new Map([['key', 'value']]), new Map([['a', 'b']]))).toBe(false);
